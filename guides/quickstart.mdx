...
<Tip>
**Want observability first?** If you want to start capturing MCP tool calls immediately before building full enforcement, the [mcp-observe SDK](/guides/mcp-observe) provides one-line instrumentation with a real-time dashboard, session tracking, and AARM-aligned receipt signing.
</Tip>
